#!/usr/bin/env python3
"""
Script de instalación automática - Parte 3: Archivos Python
Crea analytics.py y export_routes.py

Uso:
    python setup_python_files.py
"""
...
def main():
    print("="*60)
    print("🐍 INSTALACIÓN AUTOMÁTICA - ARCHIVOS PYTHON")
    print("="*60)
    print()
    
    # ============================================
    # PASO 1: Crear analytics.py (PARTE 1 de 2)
    # ============================================
    print("📊 PASO 1: Creando database/queries/analytics.py (parte 1/2)...")
    print()
...
'''
    ...
    analytics_content = analytics_part1 + analytics_part2
    
    create_file("database/queries/analytics.py", analytics_content)
    
    print()
    
    print("="*60)
    print("✅ ARCHIVOS PYTHON CREADOS")
    print("="*60)
    print()
    ...
    print()
    print("Ahora puedes:")
    print("1. Ejecutar migraciones: python database/migrations/migration_runner.py migrate")
    print("2. Usar analytics en Python:")
    print()
    print("   from database.queries.analytics import AnalyticsQueries")
    print("   analytics = AnalyticsQueries()")
    print("   df = analytics.get_session_summary()")
    print()
