#!/usr/bin/env python3
"""
Script de instalación automática - Parte 2: Analytics y Exports
Crea los archivos de análisis y exportación

Uso:
    python setup_analytics_system.py
"""
...
def main():
    print("="*60)
    print("📊 INSTALACIÓN AUTOMÁTICA - ANALYTICS Y EXPORTS")
    print("="*60)
    print()
    
    # ============================================
    # PASO 1: Crear v002_analytics_views.sql
    # ============================================
    print("🗄️  PASO 1: Creando v002_analytics_views.sql...")
    print()
    
    v002_content = """-- v002_analytics_views.sql
...
"""
    ...
    create_file("database/migrations/versions/v002_analytics_views.sql", v002_content)
    
    print()
    
    # ============================================
    # PASO 2: Crear queries/__init__.py
    # ============================================
    print("📝 PASO 2: Creando queries/__init__.py...")
    print()
    
    queries_init = """from .analytics import AnalyticsQueries

__all__ = ['AnalyticsQueries']
"""
    
    create_file("database/queries/__init__.py", queries_init)
    
    print()
    
    print("="*60)
    print("✅ ARCHIVOS SQL CREADOS")
    print("="*60)
    print()
    ...
    print("🎯 PRÓXIMO PASO:")
    print()
    print("Ejecuta el siguiente script para crear los archivos Python:")
    print("   python setup_python_files.py")
    print()
